...
namespace BusinessBears.DataAccess.Entities
{
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseSqlServer("Server=tcp:szsaunders.database.windows.net,1433;Initial Catalog=BBear;Persist Security Info=False;User ID=SzsaundersAdmin;Password=Hikarikaze1;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;");
            }
        }
